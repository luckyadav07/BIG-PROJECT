...
function DashboardLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-navy flex">
      {/* Sidebar */}
      <aside className={`fixed inset-y-0 left-0 z-40 w-64 bg-navy-light border-r border-white/10 transform transition-transform lg:translate-x-0 lg:static ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-white/10">
          ...
          <button onClick={handleLogout} className="flex items-center gap-2 w-full px-3 py-2 text-sm text-gray-400 hover:text-danger transition rounded-lg hover:bg-white/5">
